...
class ConfigModel {
  ...
  List<CompanyReliability>? companyReliability;
  bool? isAiFeatureEnabled;
  bool? isAuctionFeatureEnabled;
  bool? isActiveAuctionForCustomer;
  int? auctionCommissionPercentage;
  AuctionDurationSetting? auctionExpiredVisibilityDuration;
  bool? isAuctionEntryFeeEnabled;
  double? auctionEntryFeeAmount;
  AuctionDurationSetting? auctionUpcomingVisibilityDuration;
  AuctionDurationSetting? auctionWinnerClaimTimeLimit;
  String? systemTaxType;
  ImageFullUrl? auctionHomeBgImage;
  List<AuctionCommitment>? auctionCommitments;
  String? auctionPromotionalPopupLink;
  bool? aiShoppingAssistantStatus;
  ...
  ConfigModel(
      {this.brandSetting,
        ...
        this.companyReliability,
        this.isAiFeatureEnabled,
        this.isAuctionFeatureEnabled,
        this.isActiveAuctionForCustomer,
        this.auctionCommissionPercentage,
        this.auctionExpiredVisibilityDuration,
        this.isAuctionEntryFeeEnabled,
        this.auctionEntryFeeAmount,
        this.auctionUpcomingVisibilityDuration,
        this.auctionWinnerClaimTimeLimit,
        this.systemTaxType,
        this.auctionHomeBgImage,
        this.auctionCommitments,
        this.auctionPromotionalPopupLink,
        this.aiShoppingAssistantStatus
      });
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['company_reliability'] != null) {
      companyReliability = <CompanyReliability>[];
      json['company_reliability'].forEach((v) {
        companyReliability!.add(CompanyReliability.fromJson(v));
      });
    }
    isAiFeatureEnabled = json['is_ai_features_enabled'] == 1 || json['is_ai_features_enabled'] == true;
    isAuctionFeatureEnabled = json['auction_feature_status'] == '1' || json['auction_feature_status'] == 1 || json['auction_feature_status'] == true;
    isActiveAuctionForCustomer = json['active_auction_for_customer'] == '1' || json['active_auction_for_customer'] == 1 || json['active_auction_for_customer'] == true;
    auctionCommissionPercentage = int.tryParse(json['auction_commission_percentage'].toString());
    auctionExpiredVisibilityDuration = json['auction_expired_visibility_duration'] != null ? AuctionDurationSetting.fromJson(json['auction_expired_visibility_duration']) : null;
    isAuctionEntryFeeEnabled = json['auction_entry_fee_amount_status'] == '1' || json['auction_entry_fee_amount_status'] == 1 || json['auction_entry_fee_amount_status'] == true;
    auctionEntryFeeAmount = double.tryParse(json['auction_entry_fee_amount_value'].toString());
    auctionUpcomingVisibilityDuration = json['auction_upcoming_visibility_duration'] != null ? AuctionDurationSetting.fromJson(json['auction_upcoming_visibility_duration']) : null;
    auctionWinnerClaimTimeLimit = json['auction_winner_claim_time_limit'] != null ? AuctionDurationSetting.fromJson(json['auction_winner_claim_time_limit']) : null;
    systemTaxType = json['system_tax_type'];

    auctionHomeBgImage = json['auction_home_bg_image'] != null ? ImageFullUrl.fromJson(json['auction_home_bg_image']) : null;

    if (json['auction_commitments'] != null) {
      auctionCommitments = <AuctionCommitment>[];
      json['auction_commitments'].forEach((v) {
        auctionCommitments!.add(AuctionCommitment.fromJson(v));
      });
    }
    auctionPromotionalPopupLink = json['auction_promotional_popup_link']?.toString();
    aiShoppingAssistantStatus = json['ai_shopping_assistant_status'] == '1' || json['ai_shopping_assistant_status'] == 1 || json['ai_shopping_assistant_status'] == true;
  }
}
...
class CompanyReliability {
  String? item;
  String? title;
  int? status;
  ImageFullUrl? imageFullUrl;

  CompanyReliability({this.item, this.title, this.status, this.imageFullUrl});

  CompanyReliability.fromJson(Map<String, dynamic> json) {
    item = json['item'];
    title = json['title'];
    status = int.tryParse(json['status'].toString());
...
class AuctionDurationSetting {
  int? status;
  int? value;
  String? unit;

  AuctionDurationSetting({this.status, this.value, this.unit});

  AuctionDurationSetting.fromJson(Map<String, dynamic> json) {
    status = int.tryParse(json['status'].toString());
...
class AuctionCommitment {
  String? item;
  String? title;
  int? status;
  ImageFullUrl? imageFullUrl;

  AuctionCommitment({this.item, this.title, this.status, this.imageFullUrl});

  AuctionCommitment.fromJson(Map<String, dynamic> json) {
    item = json['item'];
    title = json['title'];
    status = int.tryParse(json['status'].toString());
    imageFullUrl = json['image_full_url'] != null
