...
import 'package:flutter_sixvalley_ecommerce/features/order_details/widgets/courier_shipment_info_card.dart';
import 'package:flutter_sixvalley_ecommerce/features/order_details/widgets/track_with_delivery_partner_button.dart';
...
class TrackingResultScreen extends StatefulWidget {
  ...
  final String? phone;
  const TrackingResultScreen({super.key, required this.orderID, this.phone});
            ...
            builder: (context, tracking, child) {
              ...
              ListView( children: [
                Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                  ...
                  if(tracking.orderDetails != null && tracking.orderDetails!.isNotEmpty && tracking.orderDetails![0].courierShipment != null)
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault, vertical: Dimensions.paddingSizeSmall),
                    child: CourierShipmentInfoCard(shipment: tracking.orderDetails![0].courierShipment!),
                  ),

                  if(tracking.orderDetails != null && tracking.orderDetails!.isNotEmpty && tracking.orderDetails![0].courierTrackingUrl != null)
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault, vertical: Dimensions.paddingSizeSmall),
                    child: TrackWithDeliveryPartnerButton(trackingUrl: tracking.orderDetails![0].courierTrackingUrl!),
                  ),
