...
class OrderDetailsModel {
  ...
  Order? order;
  CourierShipmentModel? courierShipment;
  Product? product;
  bool? isExpanded;
  ...
  OrderDetailsModel(
    ...
    _courierTrackingUrl = courierTrackingUrl;
  }
  ...
  String? get courierTrackingUrl => _courierTrackingUrl;
  ...
  OrderDetailsModel.fromJson(Map<String, dynamic> json) {
    ...
    courierShipment = json['courier_shipment'] != null ? CourierShipmentModel.fromJson(json['courier_shipment']) : null;
    ...
    if(json['courier_tracking_url'] != null){
      _courierTrackingUrl = json['courier_tracking_url'];
    } else {
      _courierTrackingUrl = null;
    }
  }
...
class CourierShipmentModel {
  ...
  factory CourierShipmentModel.fromJson(Map<String, dynamic> json) {
