      ...
      body: Consumer<ProductController>(
        builder: (context, productController, child) {
          return Column(children: [
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: Dimensions.homePagePadding,).copyWith(right: Dimensions.paddingSizeDefault),
              child: TextFormField(
              ...
              child: PaginatedListView(
                ...
                itemView :  Expanded(
                  child: MasonryGridView.count(
                    ...
                    padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault).copyWith(top: Dimensions.paddingSizeExtraSmall),
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return Padding(
                        ...
                        child: ProductCardWidget(product: productController.brandOrCategoryProductList!.products![index]),
                      );
                    },
                  ),
                ),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          Text(categoryName, style: isSelected ? titilliumSemiBold.copyWith(
          ...
          Text(totalProductCount, style: isSelected ? titilliumSemiBold.copyWith(
            fontSize: Dimensions.fontSizeSmall,
