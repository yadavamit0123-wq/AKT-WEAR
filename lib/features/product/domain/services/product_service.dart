...
class ProductService implements ProductServiceInterface{
  ...
  @override
  Future getBrandOrCategoryProductList({required bool isBrand, required int id, String searchProduct = '', required int offset, String? productType, String? brandIds, String? authorIds, String? publishingIds}) async{
    return await productRepositoryInterface.getBrandOrCategoryProductList(isBrand: isBrand, id: id, searchProduct: searchProduct, offset: offset, productType: productType, brandIds: brandIds, authorIds: authorIds, publishingIds: publishingIds);
  }
