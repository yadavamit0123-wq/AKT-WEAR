                  ...
                  builder: (context, sellerProvider,_) {
                    ...
                    sellerProvider.sellerInfoModel!.avgRating.toString() : "0";
                      ...
                      return Column(mainAxisAlignment: MainAxisAlignment.end, children: [
                        Row(children: [
                          Expanded(child: Text(sellerName, style: textMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge, color: Theme.of(context).textTheme.bodyLarge?.color),
                        ...
                        if ((sellerProvider.sellerInfoModel != null) || (rating != null && totalProduct != null && totalReview != null))...[
                          ...
                          Row(children: [
                            ...
                            Text(double.parse(rating ?? ratting).toStringAsFixed(1), style: textRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color, fontSize: Dimensions.fontSizeSmall)),
