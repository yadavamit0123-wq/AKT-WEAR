...
class ShopProductViewList extends StatefulWidget {
  ...
  ShopProductViewList({super.key, required this.scrollController, required this.sellerId, this.sellerNavigationModel, required this.slug});
    ...
    return Consumer<SellerProductController>(
      builder: (context, productController, _) {
        ...
        PaginatedListView(scrollController: widget.scrollController,
          onPaginate: (offset) async=> await productController.getSellerProductList(widget.slug.toString(), offset!, "", reload: false),
