...
class ShopRecommandedProductViewList extends StatefulWidget {
  ...
  const ShopRecommandedProductViewList({super.key, required this.scrollController, required this.slug, this.sellerNavigationModel});
                ...
                child: MasonryGridView.count(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return Padding(
                      ...
                      child: ProductCardWidget(product: productController.sellerWiseRecommendedProduct!.products![index], sellerNavigationModel: widget.sellerNavigationModel),
                    );
                  },
                ),
