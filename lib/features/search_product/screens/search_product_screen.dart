...
import 'package:flutter_sixvalley_ecommerce/features/search_product/widgets/search_app_bar_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) async {
        if (didPop) return;
        if(Provider.of<SearchProductController>(context, listen: false).searchedProduct != null) {
          Provider.of<SearchProductController>(context, listen: false).cleanSearchProduct(notify: true);
          return;
        } else {
        ...
        body: Consumer<SearchProductController>(
                builder: (context, searchProvider, child) {
                  ...
                  Padding(padding: const EdgeInsets.only(top: 15),
                    child: ProductShimmer(isHomePage: false, isEnabled : searchProvider.searchedProduct == null)) :
                                ...
                                if(searchProvider.historyList.isNotEmpty)
                                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                    ...
                                    InkWell(borderRadius: BorderRadius.circular(10),
                                      ...
                                      child: Container(padding: const EdgeInsets.symmetric(horizontal: 0,
                                        vertical:0),
