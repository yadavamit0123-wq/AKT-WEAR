            ...
            Column(children: hintList.map((hint) => Row(children: [
                Container(margin: const EdgeInsets.all(Dimensions.paddingSizeExtraSmall),
                  ...
                  decoration: BoxDecoration(color: Provider.of<ThemeController>(context).darkTheme ?
                    ColorHelper.darken(Theme.of(context).colorScheme.onPrimary, 0.5) : Theme.of(context).colorScheme.onPrimary,
                    shape: BoxShape.circle,
                    ),
                  child: Text('${hintList.indexOf(hint) + 1}',
                      style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge,))),
                const SizedBox(width: Dimensions.paddingSizeSmall,),
                Flexible(child: Text(hint, style: textRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).textTheme.bodyLarge?.color))),
              ],
            ),).toList(),)
          ],),
        ),
