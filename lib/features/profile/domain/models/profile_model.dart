...
class ProfileModel {
  ...
  ProfileModel.fromJson(Map<String, dynamic> json) {
    ...
    showAuctionMenuForUser = json['show_auction_menu_for_customer'] == '1' || json['show_auction_menu_for_customer'] == 1 || json['show_auction_menu_for_customer'] == true;
  }
