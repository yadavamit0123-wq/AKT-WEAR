                                        ...
                                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                          ...
                                          ColoredBox(
                                            ...
                                            child: Padding(padding: const EdgeInsets.only(top: Dimensions.paddingSizeSmall),
                                              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                                Expanded(
                                                  child: Padding(padding: const EdgeInsets.only(left: Dimensions.homePagePadding),
                                                    child: Column(
                                                      children: [
                                                        Row(children: [
                                                          SizedBox(
                                                    ...
                                                    children: [
                                                      Padding(
                                                        padding: const EdgeInsets.only(
                                                            bottom : Dimensions.paddingSizeSmall, left: Dimensions.homePagePadding,
                                                            right: Dimensions.homePagePadding, top: Dimensions.paddingSizeSmall
                                                        ),
                                                        child: Row(children: [
