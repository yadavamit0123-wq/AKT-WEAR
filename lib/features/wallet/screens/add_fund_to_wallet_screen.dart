...
class PaymentScreenState extends State<AddFundToWalletScreen> {
  ...
  void _initData() async {
    ...
    final settings = InAppBrowserClassSettings(
      ...
      webViewSettings: InAppWebViewSettings(javaScriptEnabled: true, isInspectable: kDebugMode, useShouldOverrideUrlLoading: true, useOnLoadResource: false),
    );
...
class MyInAppBrowser extends InAppBrowser {
  ...
  Future<NavigationActionPolicy> shouldOverrideUrlLoading(navigationAction) async {
    final Uri? uri = navigationAction.request.url?.uriValue;
    if (uri != null && uri.scheme.isNotEmpty && !['http', 'https', 'file', 'chrome', 'data', 'javascript', 'about'].contains(uri.scheme)) {
