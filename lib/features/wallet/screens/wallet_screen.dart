        ...
        SliverAppBar(
          ...
          if (isGuestMode)
            const SliverFillRemaining(
              hasScrollBody: false,
              child: Center(child: NotLoggedInWidget(fromPage: RouterHelper.walletScreen)),
            )
          else ...[
            ...
            SliverToBoxAdapter(
              child: Consumer<WalletController>(
                builder: (context, walletController, _) {
                  return (walletController.walletTransactionModel?.walletTransactionList?.isNotEmpty ?? false)
                      ? PaginatedListView(
