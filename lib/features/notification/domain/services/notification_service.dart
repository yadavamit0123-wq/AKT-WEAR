...
class NotificationService implements NotificationServiceInterface{
  ...
  @override
  Future getAuctionList({int limit = 10, int offset = 1}) {
    return notificationRepositoryInterface.getAuctionList(limit: limit, offset: offset);
  }

  @override
  Future markAuctionSeen({int? id}) {
    return notificationRepositoryInterface.markAuctionSeen(id: id);
  }
}