...
class AuctionSavedBillingAddressListScreen extends StatefulWidget {
  final bool fromGuest;
  const AuctionSavedBillingAddressListScreen({super.key, this.fromGuest = false});
  @override
  State<AuctionSavedBillingAddressListScreen> createState() => _AuctionSavedBillingAddressListScreenState();
}

class _AuctionSavedBillingAddressListScreenState extends State<AuctionSavedBillingAddressListScreen> {
  @override
  void initState() {
          ...
          return SingleChildScrollView(
            child: Column(children: [
              ...
              ListView.builder(physics: const NeverScrollableScrollPhysics(),
                ...
                itemBuilder: (context, index) {
                  return InkWell(onTap: () {
                    Provider.of<AuctionCheckoutController>(context, listen: false).setBillingAddressIndex(index);
                    ...
                    child: Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault),
                      child: Container(margin: const EdgeInsets.only(top: Dimensions.paddingSizeSmall),
                        decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),
                          ...
                          border: index == Provider.of<AuctionCheckoutController>(context).billingAddressIndex ?
              ...
              Padding(padding: EdgeInsets.only(top: MediaQuery.of(context).size.height/3),
               ...
               ): const AddressShimmerWidget(shrinkWrap: true, physics: NeverScrollableScrollPhysics()),
              ],
            ),
          );
        },
