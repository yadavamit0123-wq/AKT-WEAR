...
class AuctionChoosePaymentWidget extends StatelessWidget {
  final bool onlyDigital;
  final double totalAmount;
  const AuctionChoosePaymentWidget({super.key, required this.onlyDigital, required this.totalAmount});
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                    ...
                    children: [
                      const CustomAssetImageWidget(Images.paymentMethodSelectIcon, height: 15, width: 15),
                      ...
                      InkWell(
                        onTap: () => showModalBottomSheet(
                          ...
                          builder: (c) => AuctionPaymentMethodBottomSheetWidget(onlyDigital: onlyDigital, totalAmount: totalAmount),
                        ),
              ...
              if (orderProvider.isOfflineChecked || orderProvider.isWalletChecked || orderProvider.isCODChecked || (orderProvider.paymentMethodIndex != -1))
                const SizedBox(height: 1, child: Divider(thickness: .200)),
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        (orderProvider.paymentMethodIndex != -1)
                            ? Row(
                                children: [
                                  SizedBox(width: 40, child: CustomImageWidget(image: '${configProvider.configModel?.paymentMethodImagePath}/${configProvider.configModel!.paymentMethods![orderProvider.paymentMethodIndex].additionalDatas!.gatewayImage ?? ''}')),
                                  Padding(
