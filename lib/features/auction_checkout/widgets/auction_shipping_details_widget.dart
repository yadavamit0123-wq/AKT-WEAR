...
class AuctionShippingDetailsWidget extends StatefulWidget {
  final bool hasPhysical;
  final bool billingAddress;
  final GlobalKey<FormState> passwordFormKey;

  const AuctionShippingDetailsWidget(
      {super.key,
  ...
  @override
  State<AuctionShippingDetailsWidget> createState() =>
      _AuctionShippingDetailsWidgetState();
}

class _AuctionShippingDetailsWidgetState
    extends State<AuctionShippingDetailsWidget> {
  @override
  Widget build(BuildContext context) {
    bool isGuestMode = !Provider.of<AuthController>(context, listen: false).isLoggedIn();
    return Consumer<AuctionCheckoutController>(builder: (context, shippingProvider, _) {
      ...
      return Consumer<AddressController>(builder: (context, locationProvider, _) {
        return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          widget.hasPhysical ? Container(
            decoration: BoxDecoration(
              boxShadow: [
                BoxShadow(color: Theme.of(context).hintColor.withValues(alpha: 0.3),
                ...
                Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                  child: Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () {
                          RouterHelper.getAuctionSavedAddressListRoute(fromGuest: isGuestMode);
                        },
                        child: SizedBox(width: 20,
                          child: Image.asset(Images.edit, scale: 3, color: Theme.of(context).primaryColor)),
                      ),
                    ]),
                ),
                  ...
                  children: [
                            ...
                            Expanded(
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(locationProvider.addressList![shippingProvider.addressIndex!].contactPersonName ?? '',
                                      style: textMedium.copyWith(fontSize: Dimensions.fontSizeDefault,
                                        color: Theme.of(context).textTheme.bodyLarge?.color,
                            ...
                            Expanded(
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(locationProvider.addressList![shippingProvider.addressIndex!].phone ?? '',
                                      style: textMedium.copyWith(fontSize: Dimensions.fontSizeDefault,
                                        color: Theme.of(context).textTheme.bodyLarge?.color,
                                        overflow: TextOverflow.ellipsis),
                                      maxLines: 1,
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text('${locationProvider.addressList![shippingProvider.addressIndex!].addressType ?? ''}: ',
                                style: textMedium.copyWith(fontSize: Dimensions.fontSizeDefault,
                                  color: Theme.of(context).primaryColor),
                              ),
                              Expanded(
                                child: Text('${locationProvider.addressList![shippingProvider.addressIndex!].address ?? ''}: ',
                                  style: textMedium.copyWith(fontSize: Dimensions.fontSizeDefault,
                                    color: Theme.of(context).textTheme.bodyLarge?.color,
                                    overflow: TextOverflow.ellipsis),
                                  maxLines: 1,
                    ...
                    : SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(children: []),
                          CustomAssetImageWidget(Images.deliveryTo, height: 30, width: 30,
                            color: Theme.of(context).hintColor),
                          SizedBox(height: Dimensions.paddingSizeSmall),
                          Text('${getTranslated('please_set_your_delivery_info', context)}',
                            style: textMedium.copyWith(fontSize: Dimensions.fontSizeLarge,
                              color: Theme.of(context).hintColor),
                          ),
                        ],
          ...
          isGuestMode ? (widget.hasPhysical) ? CreateAccountWidget(formKey: widget.passwordFormKey) : const SizedBox() : const SizedBox(),
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        if (!shippingProvider.sameAsBilling)
                          InkWell(
                            onTap: () => RouterHelper.getAuctionSavedBillingAddressListRoute(fromGuest: isGuestMode),
                            child: SizedBox(width: 20,
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(locationProvider.addressList![shippingProvider.billingAddressIndex!].contactPersonName ?? '',
                                        style: textMedium.copyWith(fontSize: Dimensions.fontSizeDefault,
                                          color: Theme.of(context).textTheme.bodyLarge?.color),
                                      ),
                                    ],
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(locationProvider.addressList![shippingProvider.billingAddressIndex!].phone ?? '',
                                        style: textMedium.copyWith(fontSize: Dimensions.fontSizeDefault,
                                          color: Theme.of(context).textTheme.bodyLarge?.color),
                                      ),
                                    ],
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    CustomAssetImageWidget(Images.savedAddressLocationIcon, height: 20, width: 20),
                                    SizedBox(width: Dimensions.paddingSizeSmall),
                                    Text('${locationProvider.addressList![shippingProvider.billingAddressIndex!].addressType ?? ''}: ',
                                      style: textMedium.copyWith(fontSize: Dimensions.fontSizeDefault,
                                        color: Theme.of(context).primaryColor),
                                    ),
                                    Expanded(
                                      child: Text('${locationProvider.addressList![shippingProvider.billingAddressIndex!].address ?? ''}: ',
                                        style: textMedium.copyWith(fontSize: Dimensions.fontSizeDefault,
                                          color: Theme.of(context).textTheme.bodyLarge?.color,
                                          overflow: TextOverflow.ellipsis),
                                        maxLines: 1,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                CustomAssetImageWidget(Images.deliveryTo, height: 30, width: 30,
                                  color: Theme.of(context).hintColor),
                                SizedBox(height: Dimensions.paddingSizeSmall),
                                Text('${getTranslated('please_set_your_billing_info', context)}',
                                  style: textMedium.copyWith(fontSize: Dimensions.fontSizeLarge,
                                    color: Theme.of(context).hintColor),
                                ),
                              ],
