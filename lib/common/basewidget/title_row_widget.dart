    ...
    return Container(
      ...
      child: Stack(children: [
        ...
        Positioned(child: Align(alignment: Alignment.center, child: Padding(
          padding: EdgeInsets.symmetric(horizontal: isBackExist ? Dimensions.paddingSizeExtraSmall : Dimensions.paddingSizeLarge),
          child: Row(
...
class FlashDealBar extends StatelessWidget {
  final String title;
  final Duration? eventDuration;
  ...
  Widget build(BuildContext context) {
    ...
    if (eventDuration != null) {
      days = eventDuration!.inDays;
      hours = eventDuration!.inHours % 24;
      minutes = eventDuration!.inMinutes % 60;
      seconds = eventDuration!.inSeconds % 60;
    }
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          if (eventDuration != null && !Provider.of<ThemeController>(context, listen: false).darkTheme) ...[
            Positioned(bottom: -20, left: -6, child: SizedBox(
              width: 60, child: Image.asset(Images.currentShape, opacity: const AlwaysStoppedAnimation(.05)),
            )),
            Positioned(top: 5, left: MediaQuery.of(context).size.width / 3, child: SizedBox(
              width: 35, child: Image.asset(Images.currentShape, opacity: const AlwaysStoppedAnimation(.15),),
            )),
            Positioned(right: -2, top: -5, child: SizedBox(
              width: 25, child: Image.asset(Images.currentShape, opacity: const AlwaysStoppedAnimation(.17)),
            )),
          ],

          Padding(
            padding: EdgeInsets.symmetric(
              horizontal: isBackExist ? Dimensions.paddingSizeExtraSmall : Dimensions.paddingSizeDefault,
