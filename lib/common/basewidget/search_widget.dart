...
class _SearchWidgetState extends State<SearchWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(children: [
      ...
      Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.homePagePadding, vertical: Dimensions.paddingSizeSmall),
              ...
              child: Padding(padding:  const EdgeInsets.symmetric(
                ...
                child: TextFormField(controller: searchController,
                    ...
                    onFieldSubmitted: (val){
                      sellerProductController.getSellerProductList(widget.slug.toString(), 1, "", search: searchController.text.trim());
                    },
                    onChanged: (val){
                  setState(() {
                      ...
                      suffixIcon: searchController.text.isNotEmpty? InkWell(
                        onTap: (){
                          setState(() {
                            ...
                            sellerProductController.getSellerProductList(widget.slug.toString(), 1, "");
