import 'package:flutter_sixvalley_ecommerce/common/enums/local_caches_type_enum.dart';
  ...
  // auction
  static const String createAuctionProductsUri = '/api/v1/customer/auction/products/store';
  static const String updateAuctionProductsUri = '/api/v1/customer/auction/products/update';
  static const String creatorAuctionProductDetailsUri = '/api/v1/customer/auction/products/details';
  static const String customerAuctionProductRequestListUri = '/api/v1/customer/auction/products/pending-approval-list';
  static const String customerAuctionProductListUri = '/api/v1/customer/auction/products/list';
  static const String customerMyBidList = '/api/v1/customer/auction/products/my-bid-list';
  static const String auctionCategoriesUri = '/api/v1/customer/auction/categories';
  static const String auctionCategoryProductListUri = '/api/v1/customer/auction/products/category';
  static const String customerAuctionProductDeleteUri = '/api/v1/customer/auction/products/delete/';
  static const String customerAuctionProductCancelUri = '/api/v1/customer/auction/products/cancel/';
  static const String auctionPopularTags = '/api/v1/customer/auction/products/popular-tags';
  static const String auctionProductListUri = '/api/v1/customer/auction/products/filter';
  static const String getAuctionSuggestionProductName = '/api/v1/customer/auction/products/suggestion-product';
  static const String participationAuctionProductDetailsUri = '/api/v1/customer/auction/products/overview/';
  static const String auctionEntryFeeUri = '/api/v1/customer/auction/entry-fees/store';
  static const String auctionPlaceBidUri = '/api/v1/customer/auction/bids/place';
  static const String auctionWithdrawBidUri = '/api/v1/customer/auction/bids/withdraw';
  static const String auctionRollbackBidUri = '/api/v1/customer/auction/bids/rollback';
  static const String auctionBidListUri = '/api/v1/customer/auction/bids/list/';
  static const String auctionCreatorBidListUri = '/api/v1/customer/auction/my-auction/bids/';
  static const String auctionSaveUri = '/api/v1/customer/auction/saved-products/store';
  static const String auctionClaimUri = '/api/v1/customer/auction/claims/store';
  static const String auctionSocialShareUri = '/api/v1/customer/auction/products/social-share-link/';
  static const String auctionSaveListUri = '/api/v1/customer/auction/saved-products/list';
  static const String auctionGenerateInvoice = '/api/v1/customer/auction/products/generate-invoice/';
  static const String auctionRecentViewsUri = '/api/v1/customer/auction/recent-views/list';
  static const String auctionUploadTrackingUri = '/api/v1/customer/auction/products/tracking-url/';
  static const String auctionDeliveryStatusUri = '/api/v1/customer/auction/products/delivery-status/';

  static const String userCreatedAuctionList = '/api/v1/customer/auction/products/my-auction-list';
  static const String auctionSalesReportUri = '/api/v1/customer/auction/sales-report';
  static const String withdrawMethodListUri = '/api/v1/customer/auction/withdraw-methods/list';
  static const String auctionCommissionPayUri = '/api/v1/customer/auction/commission/pay/';
  static const String auctionWithdrawStoreOrUpdateUri = '/api/v1/customer/auction/withdraws/store-or-update';
  static const String auctionRelaunchUri = '/api/v1/customer/auction/products/relaunch/';
  static const String auctionTransactionHistoryUri = '/api/v1/customer/auction/transaction-history';


  // ai-
  static const String auctionTitleAutoFill = '/api/v1/customer/auction/product/title-auto-fill';
  static const String auctionDescriptionAutoFill = '/api/v1/customer/auction/product/description-auto-fill';
  static const String auctionGeneralSetupAutoFill = '/api/v1/customer/auction/product/general-setup-auto-fill';
  static const String auctionShippingPolicyAutoFill = '/api/v1/customer/auction/product/shipping-policy-auto-fill';
  static const String auctionInfoAutoFill = '/api/v1/customer/auction/product/auction-info-auto-fill';
  static const String auctionSeoSectionAutoFill = '/api/v1/customer/auction/product/seo-section-auto-fill';
  static const String auctionAnalyzeImageAutoFill = '/api/v1/customer/auction/product/analyze-image-auto-fill';
  static const String auctionSetupAutoFill = '/api/v1/customer/auction/product/setup-auto-fill';
  static const String auctionGenerateTitleSuggestions = '/api/v1/customer/auction/product/generate-title-suggestions';
  static const String auctionGenerateLimitCheck = '/api/v1/customer/auction/product/generate-limit-check';

  // ai-shopping (legacy)
  static const String aiShoppingSearch = '/api/v1/customer/ai-shopping/search';
  static const String aiShoppingImageSearch = '/api/v1/customer/ai-shopping/image-search';
  static const String aiShoppingLimitCheck = '/api/v1/customer/ai-shopping/generate-limit-check';

  // ai-shopping assistant v1
  static const String aiShoppingUploadImage = '/api/v1/ai/assistant/upload-image';
  static const String aiShoppingSessions = '/api/v1/ai/assistant/sessions';

  static const String auctionDashboardSummaryUri = '/api/v1/customer/auction/dashboard-summary';
  static const String auctionNotificationListUri = '/api/v1/customer/auction/notifications/list';
  static const String auctionNotificationSeenUri = '/api/v1/customer/auction/notifications/seen';
